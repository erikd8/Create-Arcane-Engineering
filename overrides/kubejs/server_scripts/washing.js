onEvent('recipes', event => {
  ...
  event.recipes.create.splashing(['minecraft:bowl', Item.of('kubejs:mage_leaf',1).withChance(0.45)],'kubejs:dirty_bowl')
  event.recipes.create.splashing('kubejs:rejuvinated_menril_shrub',['kubejs:menril_shrub'])
  event.recipes.create.splashing([Item.of('minecraft:iron_nugget').withCount(9), Item.of('minecraft:redstone',1).withChance(0.75)],'create:crushed_raw_iron')
})
